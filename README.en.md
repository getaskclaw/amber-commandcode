...
|---|---|---|
| [2026-W39](results/2026-W39.en.md)（[中文](results/2026-W39.md)） | CommandCode triple exam: grok-4.7 / mimo-v2.6-pro / mimo-v2.6-flash | mimo-v2.6-pro **17/24** (1 invalid); grok-4.7 incomplete, 7 cases held for the 09-29 same-lane re-exam; mimo-v2.6-flash was still running at press time — final filing is in the [W38 correction addendum](results/2026-W38-correction.en.md) |
