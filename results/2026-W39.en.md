...
Case handles are public aliases (cross-checked against the [amber hash-index](https://github.com/getaskclaw/amber)). Marks: ✓ pass / ✗ fail (d2 score) / ⊘ held (g47: quota-wall re-exam pending) / ◍ invalid_infrastructure / — not run.
...
3. **Attribution pins A-a317e74b**: g47 at 14/15 and m26f at 14/15 both enter the best-in-history band (passing still requires all pins, so both count as fails); m26p 10/15.
