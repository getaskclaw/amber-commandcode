...
Case handles are public aliases (cross-checked against the [amber hash-index](https://github.com/getaskclaw/amber)). Marks: ✓ pass / ✗ fail (d2 score) / ⊘ held (g47: quota-wall re-exam pending; m26f: review hold) / ◍ invalid_infrastructure / — not run.
...
| **total** | | **incomplete** (6 pass 3 fail 7⊘ 2◍ 6—) | **17/24** (1◍) | **13/24** (6 fail 3⊘ 2◍) |
...
4. **The three text-face cases**: m26p passed all (6/6, 2/2, 5/5), proving the cases are passable; m26f returned no code block on all three, booked as review holds (⊘) — the delivery-reliability doubt stands, but no fail is scored yet.
